...
[
  ...(window.dataFromSubdomain && window.dataFromSubdomain.data.pageInfos
    ...
    : [
      { text: "Káº¹o bÃ­ áº©n", image: "images/1.jpg" },
      { text: "Káº¹o dÃ¢u", image: "images/5.jpg" },
      ]),
];

const nameBook = (window.dataFromSubdomain && window.dataFromSubdomain.data.nameBook)
  ? window.dataFromSubdomain.data.nameBook : "Meo meoo";
...
if (audioPlayer) {
  audioPlayer.src = (window.dataFromSubdomain && window.dataFromSubdomain.data.song)
  ? window.dataFromSubdomain.data.song : "song.mp3";
}
...
function stopCassetteAnimation() {
  ...
  cassetteIndex = 0;
  if (cassetteImg) cassetteImg.src = "casstte/1.png";
}
